...
--insert into pacientes (primer_nombre_paciente, segundo_nombre_paciente, primer_apellido_paciente,segundo_apellido_paciente,edad_paciente) values ('Edwin', 'Roberto', 'Marroquin','Sanchez',21);--
...
--insert into polizas (id_paciente,estado_poliza, fecha_inicio_poliza,fecha_fin_poliza) values (2,'NO VIGENTE', '2011-08-12','2016-08-12');
--insert into polizas (id_paciente,estado_poliza, fecha_inicio_poliza,fecha_fin_poliza) values (3,'VIGENTE', '2018-05-09','2013-05-09');
--Citas
